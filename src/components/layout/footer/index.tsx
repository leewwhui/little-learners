...
export const Footer = () => {
  return (
    <div className="shadow-card bg-white border rounded-lg mt-32 flex flex-col gap-12 items-center justify-center py-16 px-28">
      <FooterNav />

      <div className="w-full flex flex-col gap-7">
        <div className="py-7 flex justify-between border-y">
