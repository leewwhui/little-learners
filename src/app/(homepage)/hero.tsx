...
export const Hero = () => {
  return (
    <div className="w-full flex gap-14 xl:flex-row flex-col min-h-[663px] xl:min-h-[785px]">
      <div className="xl:w-1/2 xl:h-auto w-full bg-hero bg-cover bg-center rounded-xl aspect-[1/0.9]" />
      ...
      <div className="flex-1 flex flex-col md:h-[70%] my-auto justify-between h-[80%] gap-8">
        <div className="flex flex-col lg:items-start items-center">
          ...
          <div
            className={`xl:text-[54px] leading-[130%] ${raleway.className} font-extrabold md:text-[40px] mt-3 text-[30px] text-center lg:text-left`}
          >
        ...
        <p className="xl:text-xl text-lg leading-[150%] text-center lg:text-left">
